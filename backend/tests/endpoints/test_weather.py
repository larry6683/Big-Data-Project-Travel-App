...
class Test_Weather():
    ...
    async def test_get_trip_weather_pass(self, client):
        response = client.get(
            self.api_path,
            params = {
                "lat": 10,
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_boundary_coordinates(self, client):
        response = client.get(
            self.api_path,
            params = {
                "lat": 90,
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_same_day(self, client):
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_forecast_after_30_days(self, client):
        ...
        response = client.get(
            ...
            params = {
                "lat": 10,
                "lon": 10,
                "check_in_date": str(check_in_date_two_months_ahead),
                "check_out_date": str(check_out_date_two_months_ahead)
            }
        )
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_bad_latitude(self, client):
        response = client.get(
            self.api_path,
            params = {
                "lat": 999,
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_bad_longitude(self, client):
        response = client.get(
            self.api_path,
            params = {
                "lat": 10,
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_invalid_date(self, client):
        """
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_past_dates(self, client):
        response = client.get(
            self.api_path,
            params = {
                "lat": 10,
    ...
    # @pytest.mark.skip(reason= "reduce api testing calls during development")
    async def test_get_trip_weather_check_out_date_before_check_in(self, client):
    ...
    # async def test_get_trip_weather_
